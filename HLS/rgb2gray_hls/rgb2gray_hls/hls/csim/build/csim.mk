...
HLS_SOURCES = ../../../../tb_rgb2gray.cpp ../../../../rgb2gray.cpp
...
$(ObjDir)/tb_rgb2gray.o: ../../../../tb_rgb2gray.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../tb_rgb2gray.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_rgb2gray.d

$(ObjDir)/rgb2gray.o: ../../../../rgb2gray.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../rgb2gray.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=rgb2gray $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/rgb2gray.d
