...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "rgb2gray.autotvin.dat"
	set constFileTvOut       "rgb2gray.autotvout.dat"
	set constFileHdlTvIn     "rgb2gray.autohdltvin.dat"
	set constFileHdlTvOut    "rgb2gray.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
