...
//
//==============================================================
`ifndef RGB2GRAY_SCOREBOARD__SV                                                       
    `define RGB2GRAY_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class rgb2gray_scoreboard extends uvm_component;                                        
                                                                                               
        rgb2gray_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(rgb2gray_scoreboard)                                     
