...
`define AUTOTB_DUT      rgb2gray
`define AUTOTB_DUT_INST AESL_inst_rgb2gray
`define AUTOTB_TOP      apatb_rgb2gray_top
`define AUTOTB_LAT_RESULT_FILE "rgb2gray.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "rgb2gray.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_rgb2gray_top
...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.rgb2gray.autotvin_gmem.dat"
`define AUTOTB_TVIN_r_out_wrapc  "../tv/rtldatafile/rtl.rgb2gray.autotvin_r.dat"
`define AUTOTB_TVIN_g_out_wrapc  "../tv/rtldatafile/rtl.rgb2gray.autotvin_g.dat"
`define AUTOTB_TVIN_b_out_wrapc  "../tv/rtldatafile/rtl.rgb2gray.autotvin_b.dat"
`define AUTOTB_TVIN_gray_out_wrapc  "../tv/rtldatafile/rtl.rgb2gray.autotvin_gray.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.rgb2gray.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.rgb2gray.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 921620;
parameter LENGTH_b = 1;
parameter LENGTH_g = 1;
parameter LENGTH_gmem = 1228800;
parameter LENGTH_gray = 1;
