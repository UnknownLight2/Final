...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.rgb2gray.autotvin_gmem.dat"
         "c.rgb2gray.autotvin_r.dat"
         "c.rgb2gray.autotvin_g.dat"
         "c.rgb2gray.autotvin_b.dat"
         "c.rgb2gray.autotvin_gray.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.rgb2gray.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
