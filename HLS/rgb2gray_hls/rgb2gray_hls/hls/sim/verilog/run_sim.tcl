...
if {[file isfile rgb2gray.autotvin.dat]} {
	file delete -force rgb2gray.autotvin.dat
}

if {[file isfile rgb2gray.autotvout.dat]} {
	file delete -force rgb2gray.autotvout.dat
}
